...
ECS 2.2 Multi Node installation on Google Compute Engine: 

The following instructions will allow you to install ECS 2.2 software using a GCE Deployment Manager, using a simple template file.
